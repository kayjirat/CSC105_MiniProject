import "../style/ExhibitionPage.css";
      ...
      <div class="Eventpage">
        <div className="paddingPageF">
          <div className="marginpage">
            <br />
            {/* // topic */}
            <h3 className="TopicEP">Exhibition</h3>
            <br />
            {/* Events section */}
            <Box className="eventContainerEP">
              ...
              <div className="eventPreveiew1stEP">
                ...
                <div className="eventContentEP">
                  ...
                  >
                    ...
                    Corrado Feroci (Sillap Bhirasri) <br />
                    100-year project to Siam
                  </h5>
                  <h5
                    style={{
                      fontSize: "1rem",
                  ...
                  >
                    ...
                    with Bhirasri <br />
                    Art Center Foundation and Silpakorn University
                  </h5>
                </div>
                <button
                  className="eventButtonEP"
                  onClick={() => handleClick("/exhibitionifo")}
                >
                  See All
                </button>
              </div>
              ...
              <div className="eventPreveiew3rdEP">
                ...
                >
                  12 March 2022 <br />- 27 June 2022
                </h5>

                <img
                  className="eventPictureEP"
                  src="https://images.unsplash.com/photo-1487088678257-3a541e6e3922?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1548&q=80"
                  alt="event"
                />
                <div className="eventContentEP">
                  <h5
                  ...
                  >
                    Through the Vijit Chao Phraya initiative, the colorfully-lit
                    banks of the Chao- Phraya river will be
                    <br /> the setting of an evening bill of cultural
                    performances at historic sites on both sides of the river.
                  </h5>
                </div>
                <button
                  className="eventButtonEP"
              ...
              <div className="eventPreveiew4thEP">
                ...
                >
                  14 Jan 2022 <br />- 27 June 2022
                </h5>

                <img
                  className="eventPictureEP"
                  src="https://images.unsplash.com/photo-1523726491678-bf852e717f6a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80"
                  alt="event"
                />
                ...
                <div className="eventContentEP">
                  ...
                  >
                    development of Bangkok to achieve more balance It needs to
                    rely on the <br />
                    creative power of people from different fields.
                  </h5>
                </div>
                <button
                  className="eventButtonEP"
