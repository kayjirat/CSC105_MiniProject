...
function HomePage() {
        ...
        const images = [
          { id: 1, url: 'https://images.unsplash.com/photo-1514905552197-0610a4d8fd73?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80' },
          { id: 2, url: 'https://images.unsplash.com/photo-1605429523419-d828acb941d9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2064&q=80' },
          { id: 3, url: 'https://images.unsplash.com/photo-1590342823852-2ab98729f250?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1548&q=80' },
          { id: 4, url: 'https://images.unsplash.com/photo-1561088582-5e4f2cd41a0b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1808&q=80' },
        ];
    ...
    return(
        ...
        <div class="Homepage">
                ...
                <Grid container spacing={6}>
                    <Grid item sm={6} md={4}>
                        <Card id="CardHP" sx={{ maxWidth: 350 }}>
                            <CardActionArea>
                            <a className="highlightCardLinkHP" onClick={() => handleClick("/highlightInfo")}>
                                <CardMedia
                                component="img"
                                height="250"
                                ...
                                <Typography variant="body2" color="text.secondary">
                                    22 April, 2023 <br/>
                                    From 22 to 27 April 2023 it will take part in the opening 
                                    of the V Edition of the Vip Lounge area at the 62nd
                                </Typography>
                                </CardContent>
                                </a>
                            </CardActionArea>
                        ...
                        <Card sx={{ maxWidth: 350 }}>
                            ...
                            <a className="highlightCardLinkHP" onClick={() => handleClick("/highlightInfo")}>
                                ...
                                <Typography variant="body2" color="text.secondary">
                                    ...
                                    edited by Asian Studies Group Milan, Luciana Matalon Foundation, 
                                    from 10:15 onward.
                                </Typography>
                                </CardContent>
                                </a>
                    ...
                    <Grid item sm={6} md={4}>
                        <Card sx={{ maxWidth: 350 }}>
                            ...
                            <a className="highlightCardLinkHP" onClick={() => handleClick("/highlightInfo")}>
                                ...
                                <Typography variant="body2" color="text.secondary">
                                    5 April, 2023 <br/>
                                    an artistic project by Nello Taiettifrom 5 to 27 April 2023
                                    it will take part in the opening of the V Edition
                                </Typography>
                                </CardContent>
                                </a>
                            </CardActionArea>
            ...
            {/* Events section */}
            <h3 className='eventTopicHP'>Events</h3>
            <Box className='eventContainerHP'>
                <div className='eventPreveiew1stHP'>
                    ...
                    <h5 style={{fontSize: '1rem', fontWeight: 'lighter'}}>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                    <img className='eventPictureHP' src='https://images.unsplash.com/photo-1608371945786-d47d3cdd31da?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80' alt='event'/> 
                        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <button className='eventButtonHP' onClick={() => handleClick("/eventInfo")}>See All</button>
                </div>
                <br/><hr/><br/>
                <div className='eventPreveiew2ndHP'>
                    ...
                    <h5 style={{fontSize: '1rem', fontWeight: 'lighter'}}>
                        28 April, 2023</h5>
                        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                    <img className='eventPictureHP' src='https://images.unsplash.com/photo-1580136579585-48a5311ee2f7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1608&q=80' alt='event'/> 
                        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                    <div className='eventContentHP'>
                    <h5 style={{fontSize: '1rem', fontWeight: 'bold'}}>
