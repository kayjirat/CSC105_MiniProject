...
function HighlightInfo() {
  ...
  const images = [
    {
      id: 1,
      url: "https://images.unsplash.com/photo-1544967082-d9d25d867d66?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1160&q=80",
    },
    {
      id: 2,
    ...
    {
      id: 3,
      url: "https://images.unsplash.com/photo-1577049092056-1578d3fc65e1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80",
    },
  ];
        ...
        <div className="paddingPageF">
          <div className="marginpage">
            ...
            <h2 className="highlightTopicHIP">
              ...
              <br />- Corrado Feroci (Sillap Bhirasri) 100-year project to Siam.
            </h2>
            <br />
            {/* //small slide show */}
